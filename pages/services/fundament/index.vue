...
export default {
  ...
  head() {
    return {
      ...
      meta: [
        ...
        {
          property: "og:image",
          content: DOMAIN + this.serviceData[0].img_src[0]
        },
        // Twitter Card
  ...
  data() {
    return {
      fetchedVars: {},
      DOMAIN,
      keywords: `фундамент заора, лента под забор, фундамент под еврозабор, Заливка фундамента, стоимость работ по заливке фундамента для заборов`,
