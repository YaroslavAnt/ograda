...
export default {
  ...
  data() {
    return {
      fetchedVars: {},
      DOMAIN,
      keywords: `расценки на строительство забра из профнастила, стоимость установки забора, установка забора цена, строительство забора, установка еврозаборов, монтаж ограждений`,
