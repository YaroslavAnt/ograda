...
export default {
  ...
  data() {
    return {
      title: "✔ Еврозаборы в Запорожье - ograda.zp.ua",
      description:
        "Бетонные заборы и заборы из профнастила в Запорожье с ценами от производителя. Установка ограждений, ворот и калиток под ключ. Доставка стройматериалов",
      popularProducts: [],
      slides: [],
      posts: [],
      keywords:
