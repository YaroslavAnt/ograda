...
export default {
  ...
  data() {
    return {
      ...
      description:
        "Бетонные заборы (еврозаборы) цена 180 грн/плита, заборы из профнастила цена 800 грн/м.п. в Запорожье. Установка ограждений, ворот и калиток под ключ. Доставка стройматериалов",
      popularProducts: [],
      slides: [],
      posts: [],
      keywords:
